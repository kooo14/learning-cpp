...
void StudentRecords::report_card(int sid) const{
    print("--------------------");
    print("Report card");
    print("Student name: " + get_student_name(sid));
    print("Student id: " + std::to_string(sid));
    print("--------------------");
    print("Course    Grade");
    ...
    for (const Grade& grd : grades){
        if (grd.get_student_id() == sid){
            ...
            print(get_course_name(cid) + "    " + std::to_string(get_course_credits(cid)));
        }
    }

    print("--------------------");
    print("GPA: " + std::to_string(get_GPA(sid)));
}
